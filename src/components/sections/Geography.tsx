  ...
  return (
    <section aria-labelledby="geo-title" className="bg-paper">
      <div className="shell py-[clamp(6rem,13vw,12rem)]">
        ...
        <div aria-hidden="true" className="mt-[clamp(2.5rem,6vw,5rem)]">
          <p data-reveal="line" className="display text-[20vw] leading-[0.82] md:text-[clamp(3rem,15vw,16rem)]">
            <span>{g.from}</span>
          </p>
          <div className="my-[clamp(1.25rem,3vw,2.5rem)] flex items-center gap-3 text-rust">
            <span className="shrink-0 label">AR</span>
            <span data-reveal="rule" className="h-px flex-1 bg-rust" />
          ...
          <p
            ...
            className="text-right display text-[20vw] leading-[0.82] md:text-[clamp(3rem,15vw,16rem)]"
          >
            <span>{g.to}</span>
          </p>
        </div>
