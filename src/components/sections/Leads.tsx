    ...
    >
      ...
      <figure className="mt-[clamp(2.5rem,6vw,5rem)]">
        <blockquote className="relative">
          ...
          <p
            data-reveal="up"
            className="relative pt-[clamp(3.5rem,8vw,6.5rem)] font-serif text-[clamp(2.6rem,7.6vw,8.5rem)] leading-[0.95] tracking-[-0.015em] [text-wrap:balance] md:pt-0 md:pl-[8%]"
          >
            <T v={leads.quote} />
          </p>
        </blockquote>
